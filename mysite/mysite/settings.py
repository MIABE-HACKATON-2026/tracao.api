...
SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-fallback")
...
# Frontend
FRONTEND_URL = env.str("FRONTEND_URL", default="http://localhost:5174")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Tracao API",
    "DESCRIPTION": "API pour la traçabilité cacao/café",
    "VERSION": "1.0.0",
